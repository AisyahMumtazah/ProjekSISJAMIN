    ...
    <body>
        <div id="wrapper">
            ...
            <div class="container-fluid" id="container-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <form action="savelogbook_U.jsp" method="post">
                            <!-- Horizontal Form -->
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <%try {
                                                int kod=Integer.parseInt(request.getParameter("kode"));
                                                String host = "jdbc:mysql://localhost:3306/genap2";
                                                Class.forName("com.mysql.jdbc.Driver");
                                                Connection conn = DriverManager.getConnection(host, "root", "");
                                                String query = "SELECT kode_pengembalian FROM form_logbook where kode_peminjaman='"+kod+"'";
                                                Statement stmt = conn.createStatement();
                                                ResultSet rs = stmt.executeQuery(query);
                                                while (rs.next()) {%>
                                        <div class="col-sm-9">
                                            <input type="number" name="kode_pengembalian" class="form-control"  id="kode_pengembalian" value="<%=rs.getInt(1)%>" readonly hidden>
                                        </div>
                                        <%}
                                                rs.close();
                                                stmt.close();
