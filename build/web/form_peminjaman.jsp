                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group clockpicker" id="clockPicker1">
                                                <input type="text" name="jam_mulai" class="form-control" value="07:00" id="jam_mulai">                     
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group clockpicker" id="clockPicker2">
                                                <input type="text" name="jam_selesai" class="form-control" value="12:00" id="jam_selesai">                     
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fas fa-clock"></i></span>
                                                </div>                      
                                            </div>
